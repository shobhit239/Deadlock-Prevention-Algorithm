...
int main(){
    ...
    if(att[q-1]!=0 ){
    cout<<"\nrefuse the request\n";
    cout<<"\nWait till the release of all resources held by process\n0 for no \n1 for yes\n";
    {
    cout<<"Enter your choice: "; //This part of the code will work when the process hold some resource and this part of the code will ask the
    cin >> l;
            if (l == 1) {
